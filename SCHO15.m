function [Destination_fitness, Destination_position, Convergence_curve] = SCHO15(N, Max_iteration, lb, ub, dim, fobj)
    ...
    p = 10;
    q = 9;
    Alpha = 6;  % Initial value for Alpha
    Beta = 1.55;
    ...
    while t <= Max_iteration
        ...
        ct = 1.2 + 3.6 * (1 + t / Max_iteration);    % Linearly decrease ct
