function [Destination_fitness, Destination_position, Convergence_curve] = SCHO2(N, Max_iteration, lb, ub, dim, fobj)
    ...
    % Initialize adaptive exploration rate parameter
    diversity_threshold = 0.05;
    exploration_rate = 0.5;  % Start with a neutral exploration rate
    ...
    while t <= Max_iteration
        ...
        population_std_dev = std(X, 0, 1);  % Standard deviation for each dimension
