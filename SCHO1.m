...
function [Destination_fitness,Destination_position,Convergence_curve] = SCHO1(N,Max_iteration,lb,ub,dim,fobj)
...
% Step 2: Generate opposite solutions for each candidate
opposite_X = ub + lb - X;

% Step 3: Evaluate both initial and opposite solutions, choosing the better one
for i = 1:N
    fitness_original = fobj(X(i,:));
    fitness_opposite = fobj(opposite_X(i,:));
    
    % Replace with the opposite solution if it has a better fitness
